...
import 'package:meu_doce_custo/models/recipe_category.dart';
import 'package:mobx/mobx.dart';

import '../../repositories/recipe_category_repository.dart';
import '../others/filter_search_store.dart';
import '../others/user_manager_store.dart';
...
abstract class _RecipeCategoryStore with Store {
  ...
  Future<void> loadData({int? page, required FilterSearchStore filterSearchStore}) async {
    ...
    try {
      final result = await RecipeCategoryRepository().findAllRecipeCategories(page: _page, filterSearchStore: filterSearchStore);
      addNewItems(result!);
